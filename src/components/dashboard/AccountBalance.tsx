  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
        <CardHeader className="pb-2">
          <CardTitle className="text-green-100 text-sm font-medium">Available Balance</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
            <p className="text-2xl font-bold">
      ...
      <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white">
        <CardHeader className="pb-2">
          <CardTitle className="text-orange-100 text-sm font-medium">Margin Used</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
            <p className="text-2xl font-bold">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className="text-lg font-semibold">{formatSats(balance.sats.balance || 0)} sats</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Available Sats</p>
                <p className="text-lg font-semibold">{formatSats(balance.sats.available || 0)} sats</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Margin Sats</p>
                <p className="text-lg font-semibold">{formatSats(balance.sats.margin || 0)} sats</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Unrealized P&L</p>
                <p className={cn(
                  'text-lg font-semibold',
                  (balance.sats.unrealized_pnl || 0) >= 0 ? 'text-green-600' : 'text-red-600'
                )}>
