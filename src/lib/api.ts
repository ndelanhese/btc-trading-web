...
export const lnMarketsApi = {
  ...
  updateConfig: async (data: LNMarketsConfigRequest): Promise<LNMarketsConfig> => {
    const response = await apiClient.post('api/lnmarkets/config', { json: data });
    return handleApiResponse<LNMarketsConfig>(response);
  },
};
...
export const tradingConfigApi = {
  ...
  updateMarginProtection: async (data: MarginProtectionRequest): Promise<MarginProtection> => {
    const response = await apiClient.post('api/trading/margin-protection', { json: data });
    return handleApiResponse<MarginProtection>(response);
  },
  ...
  updateTakeProfit: async (data: TakeProfitRequest): Promise<TakeProfit> => {
    const response = await apiClient.post('api/trading/take-profit', { json: data });
    return handleApiResponse<TakeProfit>(response);
  },
  ...
  updateEntryAutomation: async (data: EntryAutomationRequest): Promise<EntryAutomation> => {
    const response = await apiClient.post('api/trading/entry-automation', { json: data });
    return handleApiResponse<EntryAutomation>(response);
  },
  ...
  updatePriceAlert: async (data: PriceAlertRequest): Promise<PriceAlert> => {
    const response = await apiClient.post('api/trading/price-alert', { json: data });
    return handleApiResponse<PriceAlert>(response);
  },
};
...
export const tradingApi = {
  ...
  closePosition: async (data: ClosePositionRequest): Promise<ApiResponse<Position>> => {
    const response = await apiClient.post(`api/trading/positions/${data.id}/close`);
  ...
  updateTakeProfit: async (data: UpdateTakeProfitRequest): Promise<ApiResponse<Position>> => {
    const response = await apiClient.post(`api/trading/positions/${data.id}/take-profit`, {
  ...
  updateStopLoss: async (data: UpdateStopLossRequest): Promise<ApiResponse<Position>> => {
    const response = await apiClient.post(`api/trading/positions/${data.id}/stop-loss`, {
